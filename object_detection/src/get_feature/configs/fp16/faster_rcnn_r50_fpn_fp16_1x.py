...
model = dict(
    ...
    rpn_head=dict(
        ...
        feat_channels=256,
        anchor_scales=[8],
        anchor_ratios=[0.02, 0.08, 0.2, 0.5, 1.0, 2.0, 6.0, 18.0, 54.0],
...
train_pipeline = [
    ...
    #dict(type='Resize', img_scale=[(2048, 848), (4096, 1696)], keep_ratio=True),
    dict(type='Resize', img_scale=[(2868, 1188), (3277, 1357)], keep_ratio=True),
